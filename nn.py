...
def save_image_with_pillow(image, output_path, jpeg_quality):
    ...
    pil_image.save(output_path, "JPEG", quality=jpeg_quality, optimize=True, progressive=True)

# Function to process a single image
def process_single_image(img_path, output_folder, resize_width=None, jpeg_quality=95, clahe_clip_limit=2.0, clahe_tile_grid_size=(8, 8)):
...
def process_images_in_parallel(input_folder, output_folder, resize_width=None, jpeg_quality=95, max_workers=4, clahe_clip_limit=2.0, clahe_tile_grid_size=(8, 8)):
...
def main():
    ...
    output_folder = 'C:\\Users\\96658\\Desktop\\AI361\\project\\enhanced-images13'
    resize_width = 1920  # Set to None if you don't want to resize
    jpeg_quality = 95
    max_workers = 4
